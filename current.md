...
|Sync error appears - no option to restart sync |Android |ready for QA| v7.20|
|Deleting a group that was shared in the Community is still active and allows users request to join|iOS/Android |ready for QA| v7.20|
